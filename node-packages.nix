...
let
  sources = {
    ...
    "aes-js-git+https://github.com/mickael-kerjean/aes-js.git#76d19e46f762e9a21ab2b58ded409e70434f7610" = {
      name = "aes-js";
      packageName = "aes-js";
      version = "3.1.2";
      src = fetchgit {
    ...
    "codemirror-5.60.0" = {
      ...
      version = "5.60.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/codemirror/-/codemirror-5.60.0.tgz";
        sha512 = "AEL7LhFOlxPlCL8IdTcJDblJm8yrAGib7I+DErJPdZd4l6imx8IMgKK3RblVgBQqz3TZJR4oknQ03bz+uNjBYA==";
      };
    };
    ...
    "eslint-plugin-react-7.23.1" = {
      ...
      version = "7.23.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/eslint-plugin-react/-/eslint-plugin-react-7.23.1.tgz";
        sha512 = "MvFGhZjI8Z4HusajmSw0ougGrq3Gs4vT/0WgwksZgf5RrLrRa2oYAw56okU4tZJl8+j7IYNuTM+2RnFEuTSdRQ==";
      };
    };
    "eslint-scope-4.0.3" = {
      name = "eslint-scope";
    ...
    "pdfjs-dist-2.6.347" = {
      ...
      version = "2.6.347";
      src = fetchurl {
        url = "https://registry.npmjs.org/pdfjs-dist/-/pdfjs-dist-2.6.347.tgz";
        sha512 = "QC+h7hG2su9v/nU1wEI3SnpPIrqJODL7GTDFvR74ANKGq1AFJW16PH8VWnhpiTi9YcLSFV9xLeWSgq+ckHLdVQ==";
      };
    };
    ...
    "react-selectable-git+https://github.com/mickael-kerjean/react-selectable.git#b9da9917adf740ea88a74cc139092d12c76dd16f" = {
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."aes-js-git+https://github.com/mickael-kerjean/aes-js.git#76d19e46f762e9a21ab2b58ded409e70434f7610"
      sources."ajv-6.12.6"
      ...
      (sources."eslint-plugin-react-7.23.1" // {
        dependencies = [
      ...
      sources."react-selectable-git+https://github.com/mickael-kerjean/react-selectable.git#b9da9917adf740ea88a74cc139092d12c76dd16f"
